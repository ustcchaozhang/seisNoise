...
#./bin/xmeshfem2D > OUTPUT_FILES/output_mesher.txt modified by LT, for the need of test
mpirun -np $NPROC_SPECFEM ./bin/xmeshfem2D > OUTPUT_FILES/output_mesher.txt
