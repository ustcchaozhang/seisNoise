...
!----------------------------------
    ...
    !misfit_cur= misfit_cur_f2

    if (num_filter == 2) then
            misfit_cur =  (misfit_cur_f2+misfit_cur_f3)/2
    else if (num_filter == 3) then
            misfit_cur =  (misfit_cur_f2+misfit_cur_f3+misfit_cur_f4)/3
    else if (num_filter == 4) then
            misfit_cur =  (misfit_cur_f2+misfit_cur_f3+misfit_cur_f4+misfit_cur_f5)/4
    else
            misfit_cur =   misfit_cur_f2
    endif
